...
inline fun <reified T> ARRAY(vararg args: Expression<out T>): Expression<List<T>> = ArrayValueExpr(kListType(), args.toList())

@VaultInputValueMarker
inline fun <reified T> OBJECT(vararg pairs: Pair<Expression<String>, Expression<out T>>) = ObjectValueExpr(kType(), pairs.toList())
